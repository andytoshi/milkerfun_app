...
export const NETWORKS = {
  ...
  mainnet: {
    ...
    configPda: new PublicKey('GDwMA4g3g4jwtJ6ozGJGPk9E5XPL1pqvCXZsr2Gb93di'),
    poolAuthorityPda: new PublicKey('nsiKgYQrmFbC7oggFCEDsAghi2EyksaM7h6VWxGQarj'),
    poolTokenAccount: new PublicKey('EKA2aPHsiCmuue1wVYXmE99PmKWgbtvQA8jgY12XM1ED'),
    explorerUrl: 'https://explorer.solana.com',
  }
} as const;
